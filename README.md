...
```
Воронка | Компаратор | Воронка
Редстоун | Наблюдатель | Редстоун
Железный блок | Железный блок | Железный блок
```

## Запуск

Открой проект в IntelliJ IDEA и запусти клиент NeoForge из Gradle.
...
Готовый файл появится в папке `build/libs`.
